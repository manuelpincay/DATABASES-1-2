...
/* Created on:     24/01/2022 10:13:08                          */
/*==============================================================*/
...
/* Index: ABONO_PK                                              */
/*==============================================================*/
create unique index ABONO_PK on ABONO (
ABONO_ID
);
...
/*==============================================================*/
create  index RELATIONSHIP_13_FK on ABONO (
CONTRATO_ID
);
...
create table CONTRATO (
   ...
   CONTRATO_PAGO        INT4                 not null,
   CONTRATO_IDA         DATE                 not null,
   CONTRATO_REGRESO     DATE                 not null,
   CONTRATO_PAGO_ESTADO CHAR(50)             null,
...
create table ESTANCIA (
   ...
   CIUDAD_ID            VARCHAR(5)           not null,
   ESTANCIA_DIRECCION   VARCHAR(50)          not null,
   ESTANCIA_TELEFONO    VARCHAR(50)          not null,
   ESTANCIA_TRASLADO    VARCHAR(50)          not null,
...
/*==============================================================*/
create  index RELATIONSHIP_28_FK on ESTANCIA (
CIUDAD_ID
);
...
alter table ABONO
   add constraint FK_ABONO_RELATIONS_CONTRATO foreign key (CONTRATO_ID)
      references CONTRATO (CONTRATO_ID)
      on delete restrict on update restrict;

alter table ACTO_VANDALICO
   add constraint FK_ACTO_VAN_RELATIONS_ESTANCIA foreign key (ESTANCIA_ID)
...
alter table ESTANCIA
   add constraint FK_ESTANCIA_RELATIONS_CIUDAD foreign key (CIUDAD_ID)
...
alter table PAQUETES_TURISTICOS
   add constraint FK_PAQUETES_RELATIONS_ESTANCIA foreign key (ESTANCIA_ID)
      references ESTANCIA (ESTANCIA_ID)
      on delete restrict on update restrict;
